...
public class JSONUtil {
    ...
    public static JSONObject file2Json(String filename) throws IOException
    {
        ...
        //1.构造一个json对象
        JSONObject obj = JSONObject.parseObject(text.substring(text.indexOf("{")));   //过滤读出的utf-8前三个标签字节,从{开始读取
        return obj;
    }
}
